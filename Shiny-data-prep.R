...
covid_speeches_scot <- read_rds("covid-speeches-scot.rds")
names(covid_speeches_scot)
...
write_rds(covid_speeches_scot, file = "covid-speeches-scot.rds", compress = "xz")
write_rds(covid_speeches_scot_bigrams, file = "covid-speeches-scot-bigrams.rds", compress = "xz")
write_rds(covid_speeches_scot_words, file = "covid-speeches-scot-words.rds", compress = "xz")
...
# read data
covid_speeches_scot <- read_rds("covid-speeches-scot.rds")
covid_speeches_scot_bigrams <- read_rds( "covid-speeches-scot-bigrams.rds")
covid_speeches_scot_words <- read_rds("covid-speeches-scot-words.rds")
