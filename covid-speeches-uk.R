...
covid_speeches_uk <- read_rds("covid-speeches-uk.rds") %>%
...
write_rds(covid_speeches_uk, file = "covid-speeches-uk.rds", compress = "xz")
write_rds(covid_speeches_uk_bigrams, file = "covid-speeches-uk-bigrams.rds", compress = "xz")
write_rds(covid_speeches_uk_words, file = "covid-speeches-uk-words.rds", compress = "xz")
